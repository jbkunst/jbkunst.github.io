...
date: 2023-07-23
description: "A practical collection of ggplot2 extensions I use often."
...
post_font_family <- ggplot2::theme_get()$text$family
```
...
p_repel1 <- p1  +
  geom_text_repel(color = "gray40", family = post_font_family)
...
p1 +
  geom_mark_hull(
    ...
    label.family = post_font_family,
    description.family = post_font_family
  ) +
...
```{r}
#| code-fold: true
#| label: ggparty-parttree-comparison
#| column: page
#| out-width: 100%
#| fig-align: center
dpred_node <- penguins |>
