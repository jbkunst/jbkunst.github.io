...
`ggforce::geom_mark_hull()` wrap the full highlighted section. The short
annotations below paraphrase the [official Nürburgring Nordschleife guide](https://mobile.nuerburgring.de/info/nuerburgring/race-tracks/nordschleife?locale=en).
...
#| fig-alt: "The Nürburgring road map with nine famous Nordschleife sections highlighted in brighter green and enclosed by subtle hull annotations."
...
section_green <- "#2E8B57"

p_sections <- detail_map +
  geom_sf(
    data = track_sections,
    colour = section_green,
    linewidth = 1.70,
    lineend = "round",
    inherit.aes = FALSE
  ) +
...
Reference: [Bastián Olea's tutorial](https://bastianolea.rbind.io/blog/tutorial_mapa_openstreetmap/blob/main/tutorial_mapas_osm.qmd)
