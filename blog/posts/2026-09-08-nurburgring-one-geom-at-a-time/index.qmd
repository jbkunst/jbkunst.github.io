...
section_descriptions <- tibble::tribble(
  ~section,           ~description,
  "Fuchsröhre",       "Named after a fox found in a construction pipe.",
  "Flugplatz",        "Named after the former glider airfield.",
  "Döttinger Höhe",   "Named after nearby Döttingen.",
  "Karussell",        "The famous banked turn associated with Caracciola.",
  "Brünnchen",        "A famous spectator point on the Nordschleife."
)
...
track_sections_lines <- track_sections |>
  filter(section != "Karussell")

karussell_point <- track_sections |>
  filter(section == "Karussell") |>
...
`Nürburgring Sprintstrecke`. Keep the nearby road network for context, but reduce
its line widths so the Sprintstrecke remains the focus.
