...
OpenStreetMap stores the Nordschleife as individually named raceway ways. Reuse
the finished map and add one `ggforce::geom_circle()` layer to mark nine familiar
sections from the [official Nürburgring Nordschleife guide](https://nuerburgring.de/info/nuerburgring/race-tracks/nordschleife).

```{r}
#| label: draw-featured-raceway-sections
#| column: page
#| fig-cap: "Nine Nordschleife sections marked on the finished road map."
#| fig-alt: "The Nürburgring road map with nine famous Nordschleife sections circled in green."
...
section_points <- raceway_aux |>
  group_by(raceway_name) |>
  summarise() |>
  sf::st_point_on_surface()

section_xy <- sf::st_coordinates(section_points)
