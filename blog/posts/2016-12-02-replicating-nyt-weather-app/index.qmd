...
description: Recreating an interactive New York Times weather chart with highcharter.
date: 2016-12-02
...
install_missing_packages(c(
  "tidyverse", "highcharter", "lubridate"
))
```
...
::: {.column-body}
![Weather Chart](images/weather-chart.jpg){width=100% fig-align="center"}
:::
...
using the `create_axis` helper and then add these axes to the chart.
