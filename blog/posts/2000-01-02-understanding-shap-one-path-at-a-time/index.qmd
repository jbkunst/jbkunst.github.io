...
shap_blue <- set_plot_accent_color("#174A70")
...
compact_waterfall_plot <- ggplot(compact_bars) +
  ...
  theme(
    text = element_text(colour = "#F7FBFF"),
    axis.text = element_text(colour = "#F7FBFF"),
    axis.text.x = element_text(angle = 35, hjust = 1),
    panel.grid.major = element_line(colour = "#FFFFFF26"),
    panel.grid.minor = element_blank(),
    plot.background = element_rect(fill = shap_blue, colour = NA),
    panel.background = element_rect(fill = shap_blue, colour = NA)
  )

ggsave(
  filename = "blog/posts/2000-01-02-understanding-shap-one-path-at-a-time/images/shap-waterfall-preview.png",
