...
date: 2015-09-25
description: "Visualizing sorting algorithms step by step with ggplot2."
...
install_missing_packages(c("dplyr", "tidyr", "ggplot2", "viridis"))
```
...
```{r}
#| label: introduction-define-sort-matix-to-df
...
```{r}
#| label: introduction-prepare-df-steps
...
```{r}
#| label: introduction-define-plot-sort
...
```{r}
#| label: introduction-as-data-frame
as.data.frame(msteps)
```
...
```{r}
#| label: introduction-define-bubble-sort-steps
...
```{r}
#| label: introduction-define-selection-sort-steps
