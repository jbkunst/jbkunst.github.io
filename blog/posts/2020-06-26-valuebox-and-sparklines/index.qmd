...
# img_file <- "blog/posts/2020-06-26-valuebox-and-sparklines/images/app1_vb.png"
img_file <- "blog/posts/2020-06-26-valuebox-and-sparklines/images/app1_vb.png"

appshot(shinyApp(ui, server), file = img_file, zoom = 2, vheight = 500)

knitr::asis_output(sprintf("![](/%s)", img_file))
```
...
img_file <- "blog/posts/2020-06-26-valuebox-and-sparklines/images/vb1.png"
...
img_file <- "blog/posts/2020-06-26-valuebox-and-sparklines/images/vb2.png"
...
# shiny::shinyApp(ui, server, options = list(launch.browser = .rs.invokeShinyPaneViewer))
img_file <- "blog/posts/2020-06-26-valuebox-and-sparklines/images/vb3.png"
...
img_file <- "blog/posts/2020-06-26-valuebox-and-sparklines/images/vb4.png"
...
img_file <- "blog/posts/2020-06-26-valuebox-and-sparklines/images/vb5.png"
...
img_file <- "blog/posts/2020-06-26-valuebox-and-sparklines/images/vb6.png"

appshot(shinyApp(ui, server), selector = "#vbox2", file = img_file, zoom = 2, delay = 2)

img_file <- "blog/posts/2020-06-26-valuebox-and-sparklines/images/vb7.png"

appshot(shinyApp(ui, server), selector = "#vbox3", file = img_file, zoom = 2, delay = 2)

img_file <- "blog/posts/2020-06-26-valuebox-and-sparklines/images/app2_vb.png"
...
img_file <- "blog/posts/2020-06-26-valuebox-and-sparklines/images/vb8.png"

appshot(shinyApp(ui, server), selector = "#vbox", file = img_file, zoom = 2, delay = 2)

img_file <- "blog/posts/2020-06-26-valuebox-and-sparklines/images/vb9.png"

appshot(shinyApp(ui, server), selector = "#vbox2", file = img_file, zoom = 2, delay = 2)

img_file <- "blog/posts/2020-06-26-valuebox-and-sparklines/images/vb10.png"

appshot(shinyApp(ui, server), selector = "#vbox3", file = img_file, zoom = 2, delay = 2)

img_file <- "blog/posts/2020-06-26-valuebox-and-sparklines/images/app3_vb.png"
