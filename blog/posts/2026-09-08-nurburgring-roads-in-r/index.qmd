...
# Keep the same proportions and a transparent device background in the post.
knitr::opts_chunk$set(
  fig.asp = 1 / screen_ratio,
...
map_theme <- theme_void(base_family = map_font) +
  theme(
    ...
    # Only the map panel is filled; the area behind the caption stays transparent.
...
# Reuse styling and attribution independently of the coordinate system.
...
dark_map <- detail_canvas +
  ...
  scale_colour_identity() +
  scale_linewidth_identity() +
  # Only the panel changes; the transparent caption area keeps its shared styling.
  theme(
...
A transparent export background preserves the clear area behind the caption.
